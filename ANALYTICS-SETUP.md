...
- **Lead events** → a `generate_lead` (GA4) + `conversion` (Google Ads) + `submit_lead_form` (Bing) fire automatically when a visitor clicks **Talk to our experts, Book a demo, Submit RFP, or any mailto** link.
